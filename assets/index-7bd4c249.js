...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:rn,depthTest:!1,depthWrite:!1})}function ta(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qr(),fragmentShader:`
		...
		`,blending:rn,depthTest:!1,depthWrite:!1})}function na(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qr(),fragmentShader:`
